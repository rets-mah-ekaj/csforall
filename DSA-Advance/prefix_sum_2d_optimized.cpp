...
int main() {
    ...
    for (int cum_row_index = 1; cum_row_index < rows; ++cum_row_index) {
        for (int cum_col_index = 1; cum_col_index < cols; ++cum_col_index) {
            cum_matrix[cum_row_index][cum_col_index] = cum_matrix[cum_row_index][cum_col_index - 1]
                                                    + cum_matrix[cum_row_index - 1][cum_col_index]
                                                    - cum_matrix[cum_row_index - 1][cum_col_index - 1]
                                                    + matrix[cum_row_index][cum_col_index];
        }
    }
